...
config = {
    # Model selection: 'model', 'model_n', 'model_n_hv', 'model_hierarchical'
    ...
    "data": {
        ...
        "noise_model": "proportional",  # "proportional", "additive", "constant", "prop_quad"
    ...
    "priors": {
        ...
        "hyper": {
            ...
            "length_scales": {
                "lambda_P": {"log_mean": 2.5, "log_scale": 0.5},
            ...
            "sigma_measure_base": {"log_mean": np.log(0.001), "log_scale": 0.1},
            "sigma_constant": {
                "log_mean": np.log(0.001), "log_scale": 0.5
            },  # For constant noise model
            "sigma_latent": {"target_dist": dist.Exponential(100.0)}, # Hierarchical model latent variance
        },
        # Bias Priors
        "bias_priors": {

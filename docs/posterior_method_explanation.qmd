...
> **Note:** This document explains the `posterior_predict` function, which is used for **both prior and posterior predictions**. The difference is in what data we condition on (see `prediction_methodology.qmd` for details).

...
This document details the methodology used in `analyze.py` (via `run_residual_analysis`) to validate the statistical assumptions of the Bayesian model, specifically the measurement error model.

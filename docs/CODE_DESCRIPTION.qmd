...
**Refactored common analysis script** that replaces earlier specific scripts (e.g., `posterior_no_bias.py`).

*   **Unified Analysis**: Handles loading results, plotting experimental data, and generating posterior predictions.
*   **Residual Analysis (Optional)**: Can optionally run the full residual analysis (bands, histograms, Q-Q plots) if enabled in the config.
